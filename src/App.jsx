    ...
    <div style={{ background: C.bg, color: C.t1, fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", overflowX: "hidden" }}>
        ...
        <Section style={{ textAlign: "center", paddingTop: 100, paddingBottom: 60, position: "relative" }}>
          ...
          <FadeIn delay={0.2}>
            <p style={{ fontSize: "clamp(16px, 2vw, 20px)", color: C.t3, maxWidth: 600, margin: "0 auto 36px", lineHeight: 1.6, fontWeight: 400 }}>
              The UK's first marketplace connecting location marshals with film & TV productions. Get matched to jobs instantly. Build your reputation. Get paid reliably.
            </p>
          </FadeIn>
          <FadeIn delay={0.3}>
          ...
          <FadeIn delay={0.4}>
            <div style={{ display: "flex", gap: 32, justifyContent: "center", marginTop: 50, flexWrap: "wrap" }}>
              {[
                { n: <Counter end={6.8} suffix="bn" prefix="£" />, l: "UK production spend in 2025" },
                { n: <Counter end={361} suffix="+" />, l: "Productions shot in the UK" },
                { n: <Counter end={0} suffix="" prefix="" />, l: "Platforms built for marshals", override: "0" },
              ].map((s, i) => (
                <div key={i} style={{ textAlign: "center" }}>
                  <div style={{ fontSize: 32, fontWeight: 900, color: i === 2 ? C.orange : C.t1 }}>{i === 2 ? "0" : s.n}</div>
          ...
          <FadeIn>
            <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto" }}>
              ...
              <p style={{ fontSize: 16, color: C.t3, lineHeight: 1.7 }}>
                Right now, hiring location marshals means posting in WhatsApp groups with hundreds of people, hoping the right ones see it in time, and manually tracking who's confirmed. No ratings. No profiles. No accountability. Good marshals are invisible and unreliable ones keep getting hired.
              </p>
            </div>
          </FadeIn>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16, marginTop: 48 }}>
            {[
              { icon: "😤", title: "For Location Managers", points: ["Scrolling through hundreds of messages to find 4 marshals", "No way to check ratings or reliability", "No audit trail for production accounting", "If someone no-shows, there's zero accountability"] },
              { icon: "😩", title: "For Marshals", points: ["Constantly monitoring multiple WhatsApp groups", "Miss a message by 10 minutes and the job's gone", "No way to build a portable reputation", "Good work goes unrecognised — you're just another name in a chat"] },
            ].map((c, i) => (
      ...
      <Section id="how">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
          {[
            { step: "01", icon: "📝", title: "Post a Job", desc: "Location manager posts the job in under 60 seconds — date, location, rate, slots needed.", color: C.accent },
            ...
            { step: "03", icon: "⚡", title: "Apply & Book", desc: "Marshals apply with one tap. Managers review ratings, reliability, and certs — then book instantly.", color: C.green },
            { step: "04", icon: "⭐", title: "Rate & Repeat", desc: "Both sides rate each other after the job. Build reputation. Find your go-to crew. Get rebooked.", color: C.orange },
          ].map((s, i) => (
      ...
      <Section>
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 16, color: C.t3, maxWidth: 600, margin: "0 auto", lineHeight: 1.6 }}>
              361 productions shot in the UK in 2025. Every single one needed marshals. We're building the infrastructure to connect them.
            </p>
          </div>
        </FadeIn>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
          {[
            ...
            { n: "361", l: "Films & HETV shows produced", sub: "Including Harry Potter, Avengers, The Beatles" },
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 500 }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ padding: "14px 16px", textAlign: "center", fontSize: 13, color: C.accent, fontWeight: 700, borderBottom: `1px solid ${C.accent}33`, background: `${C.accent}08`, borderRadius: "12px 12px 0 0" }}>MarshalHQ</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ["Time to fill", "Hours", "Minutes"],
                    ["Quality assurance", "None", "Ratings + reliability scores"],
                    ["Availability visibility", "None", "Real-time calendar"],
                    ["Accountability", "None", "Review system + no-show tracking"],
                    ["Payment", "Manual bank transfers", "Automated with invoicing"],
                    ["Compliance", "Manual cert checks", "Verified profiles"],
                    ["Search & filter", "Impossible", "By rating, distance, certs"],
          ...
          <FadeIn>
            <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
              ...
              <p style={{ fontSize: 15, color: C.t3, lineHeight: 1.6, marginBottom: 32 }}>
                We're launching soon. Join the waitlist to get early access, zero platform fees for 3 months, and Founding Member status.
              </p>

              {submitted ? (
                <div style={{ padding: 40, background: `${C.green}10`, border: `1px solid ${C.green}33`, borderRadius: 20 }}>
                  <div style={{ fontSize: 52, marginBottom: 12 }}>🎬</div>
                  <div style={{ fontSize: 24, fontWeight: 900, color: C.green }}>You're on the list!</div>
                  <div style={{ fontSize: 14, color: C.t3, marginTop: 10, lineHeight: 1.6 }}>
                    We'll be in touch soon with early access details.<br/>
                    {role === "marshal" ? "In the meantime, spread the word to other marshals." : "In the meantime, tell your locations team."}
                  </div>
                ...
                <div style={{ background: C.s2, borderRadius: 24, padding: 32, border: `1px solid ${C.b1}`, textAlign: "left" }}>
                  ...
                  <div style={{ textAlign: "center", marginTop: 14 }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 12, color: C.t4 }}>
                      <span style={{ fontSize: 14 }}>🔒</span> No spam. Unsubscribe anytime.
                    </div>
                  </div>
                </div>
              )}
        ...
        <Section style={{ paddingTop: 32, paddingBottom: 32 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: C.t4, marginTop: 4 }}>The UK's marketplace for film location marshals</div>
            </div>
