  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", padding: 20 }}>
      <div style={{ textAlign: "center", maxWidth: 400, width: "100%" }}>
        <div style={{ fontSize: 36, fontWeight: 900, letterSpacing: -2, background: "linear-gradient(135deg,#6366f1,#818cf8,#c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: 8 }}>MarshalHQ</div>
        ...
        <div style={{ background: C.s2, borderRadius: 20, padding: 32, border: "1px solid " + C.b1, textAlign: "left" }}>
          <label style={{ fontSize: 12, fontWeight: 700, color: C.t3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8, display: "block" }}>Enter password to continue</label>
          <input type="password" value={pw} onChange={function(e) { setPw(e.target.value); }} onKeyDown={function(e) { if (e.key === "Enter") check(); }} placeholder="Password" style={{ width: "100%", padding: "13px 16px", background: C.s3, border: "1px solid " + (wrong ? C.red : C.b1), borderRadius: 12, color: C.t1, fontSize: 14, fontFamily: "inherit", boxSizing: "border-box", marginBottom: 14, outline: "none" }} />
          {wrong && <div style={{ fontSize: 13, color: C.red, marginBottom: 10, textAlign: "center" }}>Incorrect password</div>}
          <button onClick={check} style={{ width: "100%", padding: "14px", background: "linear-gradient(135deg,#6366f1,#4f46e5)", color: "#fff", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: "pointer" }}>Sign In</button>
        </div>
...
export default function LandingPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("https://formspree.io/f/xwvnydov", {
        ...
        body: JSON.stringify({ name: name, email: email, role: role, location: location }),
      });
  ...
  if (!unlocked) {
    return <GatePage onUnlock={function() { setUnlocked(true); }} />;
  }
  ...
  return (
    <div style={{ background: C.bg, color: C.t1, fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "#050508dd", backdropFilter: "blur(20px)", borderBottom: "1px solid #22223044" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "14px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: -1, background: "linear-gradient(135deg,#6366f1,#818cf8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>MarshalHQ</div>
      ...
      <div style={{ position: "relative", overflow: "hidden", paddingTop: 80 }}>
        <div style={{ position: "absolute", top: -200, left: "50%", transform: "translateX(-50%)", width: 800, height: 800, borderRadius: "50%", background: "radial-gradient(circle, #6366f112 0%, transparent 70%)", pointerEvents: "none" }} />
        <Section style={{ textAlign: "center", paddingTop: 100, paddingBottom: 60, position: "relative" }}>
          <FadeIn>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#6366f115", border: "1px solid #6366f133", borderRadius: 50, padding: "6px 18px", marginBottom: 28, fontSize: 13, color: C.accentL, fontWeight: 600 }}>
          ...
          <FadeIn delay={0.1}>
            <h1 style={{ fontSize: "clamp(36px, 6vw, 68px)", fontWeight: 900, lineHeight: 1.05, letterSpacing: -2, maxWidth: 800, margin: "0 auto 20px" }}>
              ...
              <span style={{ background: "linear-gradient(135deg,#6366f1,#818cf8,#c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Start getting booked.</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.2}>
          ...
          <FadeIn delay={0.3}>
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <button className="cta-btn" onClick={scrollToForm} style={{ background: "linear-gradient(135deg,#6366f1,#4f46e5)", color: "#fff", border: "none", padding: "16px 36px", borderRadius: 14, fontSize: 17, fontWeight: 800, cursor: "pointer", boxShadow: "0 4px 20px #6366f144" }}>
                Join the Waitlist
              </button>
          ...
          <FadeIn delay={0.4}>
            <div style={{ display: "flex", gap: 32, justifyContent: "center", marginTop: 50, flexWrap: "wrap" }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 32, fontWeight: 900, color: C.t1 }}><Counter end={6.8} suffix="bn" prefix={"\u00a3"} /></div>
                <div style={{ fontSize: 12, color: C.t4, marginTop: 4, maxWidth: 160 }}>UK production spend in 2025</div>
              </div>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 32, fontWeight: 900, color: C.t1 }}><Counter end={361} suffix="+" /></div>
                <div style={{ fontSize: 12, color: C.t4, marginTop: 4, maxWidth: 160 }}>Productions shot in the UK</div>
              </div>
              <div style={{ textAlign: "center" }}>
              ...
              <FadeIn key={i} delay={i * 0.15}>
                <div className="card-hover" style={{ background: C.s2, borderRadius: 20, padding: 28, border: "1px solid " + C.b1, height: "100%" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {c.points.map(function(p, j) { return (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
          {[
            ...
            <FadeIn key={i} delay={i * 0.12}>
              <div className="card-hover" style={{ background: C.s2, borderRadius: 20, padding: 28, border: "1px solid " + C.b1, textAlign: "center", height: "100%" }}>
      ...
      <div style={{ background: C.s1 }} id="why">
        <Section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
            <FadeIn>
              <div style={{ background: "linear-gradient(135deg, #6366f108, #6366f103)", borderRadius: 20, padding: 32, border: "1px solid #6366f122" }}>
                <div style={{ fontSize: 32, marginBottom: 12 }}>{"\ud83c\udfac"}</div>
                <div style={{ fontSize: 20, fontWeight: 800, color: C.t1, marginBottom: 16 }}>For Location Managers</div>
                {["Post a job and reach verified marshals in seconds", "Filter by rating, reliability, distance and certifications", "One-tap booking with instant confirmation", "Build a Favourites list for repeat hires", "Automated invoicing and payment processing", "Production-level dashboard for multi-day shoots"].map(function(f, i) { return (
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 500 }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ padding: "14px 16px", textAlign: "center", fontSize: 13, color: C.accent, fontWeight: 700, borderBottom: "1px solid #6366f133", background: "#6366f108" }}>MarshalHQ</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={i}>
                      <td style={{ padding: "12px 16px", fontSize: 13, fontWeight: 600, color: C.t2, borderBottom: "1px solid #22223022" }}>{row[0]}</td>
                      <td style={{ padding: "12px 16px", textAlign: "center", fontSize: 13, color: C.red, borderBottom: "1px solid #22223022" }}>{row[1]}</td>
                      <td style={{ padding: "12px 16px", textAlign: "center", fontSize: 13, color: C.green, fontWeight: 600, borderBottom: "1px solid #22223022", background: "#6366f105" }}>{row[2]}</td>
                    </tr>
                  ); })}
                </tbody>
              </table>
      ...
      <div ref={formRef}>
        <Section style={{ paddingTop: 80, paddingBottom: 100 }}>
          <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
            ...
            {submitted ? (
              <div style={{ padding: 40, background: "#10b98110", border: "1px solid #10b98133", borderRadius: 20 }}>
                <div style={{ fontSize: 52, marginBottom: 12 }}>{"\ud83c\udfac"}</div>
                <div style={{ fontSize: 24, fontWeight: 900, color: C.green }}>You are on the list!</div>
                <div style={{ fontSize: 14, color: C.t3, marginTop: 10, lineHeight: 1.6 }}>We will be in touch soon with early access details.</div>
              ...
              <div style={{ background: C.s2, borderRadius: 24, padding: 32, border: "1px solid " + C.b1, textAlign: "left" }}>
                <div style={{ marginBottom: 20 }}>
                  <label style={{ fontSize: 12, fontWeight: 700, color: C.t3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 10, display: "block" }}>I am a...</label>
                  <div style={{ display: "flex", gap: 10 }}>
                    <button onClick={function() { setRole("marshal"); }} style={{ flex: 1, padding: "16px 12px", background: role === "marshal" ? "#6366f115" : C.s3, border: "2px solid " + (role === "marshal" ? C.accent : C.b1), borderRadius: 14, cursor: "pointer", textAlign: "center" }}>
                      <div style={{ fontSize: 24, marginBottom: 4 }}>{"\ud83e\uddba"}</div>
                      <div style={{ fontSize: 13, fontWeight: 700, color: role === "marshal" ? C.accent : C.t2 }}>Location Marshal</div>
                    </button>
                    <button onClick={function() { setRole("manager"); }} style={{ flex: 1, padding: "16px 12px", background: role === "manager" ? "#6366f115" : C.s3, border: "2px solid " + (role === "manager" ? C.accent : C.b1), borderRadius: 14, cursor: "pointer", textAlign: "center" }}>
                      <div style={{ fontSize: 24, marginBottom: 4 }}>{"\ud83c\udfac"}</div>
                      <div style={{ fontSize: 13, fontWeight: 700, color: role === "manager" ? C.accent : C.t2 }}>Location Manager</div>
                    </button>
                  </div>
                </div>

                <div style={{ marginBottom: 14 }}>
                  <label style={{ fontSize: 12, fontWeight: 700, color: C.t3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 6, display: "block" }}>Full Name</label>
                  <input value={name} onChange={function(e) { setName(e.target.value); }} placeholder="Your name" style={{ width: "100%", padding: "13px 16px", background: C.s3, border: "1px solid " + C.b1, borderRadius: 12, color: C.t1, fontSize: 14, fontFamily: "inherit", boxSizing: "border-box" }} />
                </div>

                <div style={{ marginBottom: 14 }}>
                  <label style={{ fontSize: 12, fontWeight: 700, color: C.t3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 6, display: "block" }}>Email</label>
                  <input value={email} onChange={function(e) { setEmail(e.target.value); }} type="email" placeholder="you@email.com" style={{ width: "100%", padding: "13px 16px", background: C.s3, border: "1px solid " + C.b1, borderRadius: 12, color: C.t1, fontSize: 14, fontFamily: "inherit", boxSizing: "border-box" }} />
                </div>

                <div style={{ marginBottom: 20 }}>
                  <label style={{ fontSize: 12, fontWeight: 700, color: C.t3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 6, display: "block" }}>Where are you based?</label>
                  <input value={location} onChange={function(e) { setLocation(e.target.value); }} placeholder="e.g. London, Manchester, Bristol" style={{ width: "100%", padding: "13px 16px", background: C.s3, border: "1px solid " + C.b1, borderRadius: 12, color: C.t1, fontSize: 14, fontFamily: "inherit", boxSizing: "border-box" }} />
                </div>

                {error && <div style={{ padding: "10px 14px", background: "#ef444415", border: "1px solid #ef444433", borderRadius: 10, marginBottom: 14, fontSize: 13, color: C.red, textAlign: "center" }}>{error}</div>}

                <button className="cta-btn" onClick={handleSubmit} disabled={!email || !role || submitting} style={{ width: "100%", padding: "16px", background: !email || !role ? C.b1 : "linear-gradient(135deg,#6366f1,#4f46e5)", color: "#fff", border: "none", borderRadius: 14, fontSize: 16, fontWeight: 800, cursor: !email || !role || submitting ? "not-allowed" : "pointer", boxShadow: email && role ? "0 4px 20px #6366f144" : "none", opacity: submitting ? 0.7 : 1 }}>
      ...
      {!submitted && (
        <div style={{ background: C.s1 }}>
          <Section style={{ paddingTop: 50, paddingBottom: 50 }}>
            <FadeIn>
              <div style={{ background: "linear-gradient(135deg, #6366f110, #818cf808)", borderRadius: 24, padding: "40px 32px", border: "1px solid #6366f122", textAlign: "center", maxWidth: 700, margin: "0 auto" }}>
      ...
      <div style={{ borderTop: "1px solid #22223022" }}>
        <Section style={{ paddingTop: 32, paddingBottom: 32 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div>
              <div style={{ fontSize: 18, fontWeight: 900, background: "linear-gradient(135deg,#6366f1,#818cf8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>MarshalHQ</div>
